...
const ReposCard = ({repo}) => {
  ...
  const forkIcon = <OcticonsIcon name="repo-forked" size={15} color="#00ee00"/>;
  ...
  return (
    <Card style={{margin:4}}>
      ...
      <Card.Content>
        ...
        <Paragraph>{repo.language}     {starIcon} {repo.stargazers_count}     {forkIcon} {repo.forks_count}</Paragraph>
      </Card.Content>
    </Card>
  )
};
